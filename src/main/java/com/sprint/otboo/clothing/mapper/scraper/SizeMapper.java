...
public class SizeMapper {
    ...
    private static List<String> getKeywords(Size size) {
        return switch (size) {
            case XS -> List.of("XS", "엑스스몰", "작은사이즈");
            case S -> List.of("S", "스몰");
            case M -> List.of("M", "미디움", "미디엄", "중간");
            case L -> List.of("L", "라지", "빅");
            case XL -> List.of("XL", "X-LARGE", "빅라지", "엑스라지", "엑스엘");
            case XXL -> List.of("XXL", "2XL", "2X-LARGE", "더블엑스라지", "투엑스", "투엑스라지");
            case XXXL -> List.of("XXXL", "3XL", "3X-LARGE", "트리플엑스라지", "쓰리엑스", "쓰리엑스라지");
            case FREE -> List.of("FREE", "원사이즈", "프리", "ONE SIZE", "ONESIZE", "FREE SIZE");
            case ONE_SIZE -> List.of("ONE", "ONE-SIZE");
            default -> List.of();
        };
    }
}
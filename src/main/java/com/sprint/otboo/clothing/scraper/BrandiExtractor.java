...
/**
 * Brandi 상품 페이지에서 의상 정보를 추출하는 {@link ClothesExtractor} 구현체
 *
 * <p>지원 URL: brandi.co.kr</p>
 *
 * <p>추출 방식:</p>
 * <ul>
...
public class BrandiExtractor implements ClothesExtractor {
     ...
     *
     * @param url 요청 URL
     * @return brandi.co.kr 포함 여부
     */
    @Override
    public boolean supports(String url) {
        return url.contains("brandi.co.kr");
    }
    ...
    public ClothesDto extract(String url) {
        try {
            ...
            Document doc = Jsoup.connect(url)
                ...
                .header("Referer", "https://www.brandi.co.kr")
                .get();
            ...
            // 6. DTO 변환: 추출 속성을 DB 정의 기반 selectable 값 매핑
            ...
            throw new ClothesExtractionException("Brandi URL에서 의상 정보를 추출하지 못했습니다.", e);
        }
    }
}